"""
Django settings for ff_backend project.
...
SECRET_KEY = "django-insecure-6nal!y_k9@8+f&_#lj%q027cmmbm+o7h(**c0b6l1gaymro1cj"
...
INSTALLED_APPS = [
    ...
    # Your app
    'api',                             # ← change to your actual app name if different
]
...
WSGI_APPLICATION = "ff_backend.wsgi.application"
...
# Media files (user uploaded - screenshots, banners, proofs)
MEDIA_URL = "/media/"
...
# File upload size limit (for screenshots)
DATA_UPLOAD_MAX_MEMORY_SIZE = 5242880       # 5MB
FILE_UPLOAD_MAX_MEMORY_SIZE = 5242880       # 5MB


# Logging (optional but helpful in development)
LOGGING = {
    'version': 1,
